...
def main(): 
    ...
    #editing start and end coordinates
    #srav2_data['start'] = pd.to_numeric(srav2_data['start'])
    #srav2_data.loc[:,'start'] += 2
    #srav2_data['end'] = pd.to_numeric(srav2_data['end'])
    #srav2_data.loc[:,'end'] -= 2
    ...
    #srav3_data.loc[:,'28168'] *=  avg_total_cov_srav3
    ...
    coverage_thresholds = [(0,0), (1/avg_total_cov_srav2,1/avg_total_cov_srav3), 
                           (2/avg_total_cov_srav2,2/avg_total_cov_srav3)]
